    ...
    <div className="app__career-container">
      ...
      <div className="app__career-container-info">
        ...
        <p className="app__career-container-info_para">
          ...
          requires me to be organized and structured, involves a little bit of
          math (enough to make me feel confident about it) and presents it all
          as the pleasing, engaging and, overall, nice and fair interfaces with
          which we interact on a daily basis. It feels magical and I&apos;m so
          grateful for having the means to learn and work on something I truly
